...
export default function StudentDashboard() {
  ...
  const { statCards, applications, interviews, documents, programs, refresh, refreshKey } = useStudentDashboard();
  ...
  useEffect(() => {
    ...
    Promise.resolve().then(() => setUserData(user));
  }, [router]);

  // Remove unused handleLogout to fix unused-vars warning
            ...
            return (
              <Card key={stat.key} className="border border-slate-100 shadow-sm">
                ...
                <CardContent className="space-y-3">
                  <div className="text-3xl font-semibold text-slate-900"><CountUp target={stat.value} trigger={refreshKey} /></div>
